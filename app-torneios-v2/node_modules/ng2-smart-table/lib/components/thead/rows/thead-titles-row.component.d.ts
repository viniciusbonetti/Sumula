...
export declare class TheadTitlesRowComponent implements OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TheadTitlesRowComponent, "[ng2-st-thead-titles-row]", never, { "grid": "grid"; "isAllSelected": "isAllSelected"; "source": "source"; }, { "sort": "sort"; "selectAllRows": "selectAllRows"; }, never, never, false>;
}
