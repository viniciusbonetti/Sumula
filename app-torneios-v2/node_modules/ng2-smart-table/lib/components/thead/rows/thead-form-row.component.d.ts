...
export declare class TheadFormRowComponent implements OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TheadFormRowComponent, "[ng2-st-thead-form-row]", never, { "grid": "grid"; "row": "row"; "createConfirm": "createConfirm"; }, { "create": "create"; }, never, never, false>;
}
