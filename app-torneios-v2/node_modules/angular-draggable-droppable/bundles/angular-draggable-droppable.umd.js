    ...
    var DraggableDirective = /** @class */ (function () {
        ...
        DraggableDirective.prototype.ngOnInit = function () {
            ...
            var pointerDragged$ = this.pointerDown$.pipe(operators.filter(function () { return _this.canDrag(); }), operators.mergeMap(function (pointerDownEvent) {
                ...
                if (_this.dragPointerDown.observers.length > 0) {
                ...
                dragStarted$.subscribe(function (_a) {
                    ...
                    if (_this.dragStart.observers.length > 0) {
                        _this.zone.run(function () {
                    ...
                    if (_this.ghostDragEnabled) {
                        ...
                        if (_this.ghostElementCreated.observers.length > 0) {
                            _this.zone.run(function () {
                ...
                dragEnded$
                    ...
                    if (_this.dragEnd.observers.length > 0) {
                        _this.zone.run(function () {
        ...
        DroppableDirective.prototype.ngOnInit = function () {
            ...
            this.currentDragSubscription = this.draggableHelper.currentDrag.subscribe(function (drag$) {
                ...
                var overlaps$ = drag$.pipe(operators.map(function (_a) {
                    ...
                    currentDragEvent = { clientX: clientX, clientY: clientY, dropData: dropData, target: target };
                    ...
                    var isDropAllowed = !_this.validateDrop ||
                        _this.validateDrop({ clientX: clientX, clientY: clientY, target: target, dropData: dropData });
                ...
                overlapsChanged$
                    ...
                    if (_this.dragEnter.observers.length > 0) {
                        _this.zone.run(function () {
                            _this.dragEnter.next(currentDragEvent);
                        });
                    }
                });
                overlaps$.pipe(operators.filter(function (overlapsNow) { return overlapsNow; })).subscribe(function () {
                    if (_this.dragOver.observers.length > 0) {
                        _this.zone.run(function () {
                            _this.dragOver.next(currentDragEvent);
                        });
                    }
                });
                overlapsChanged$
                    ...
                    if (_this.dragLeave.observers.length > 0) {
                        _this.zone.run(function () {
                            _this.dragLeave.next(currentDragEvent);
                        });
                    }
                });
                drag$.subscribe({
                    complete: function () {
                        ...
                        if (dragOverActive) {
                            removeClass(_this.renderer, _this.element, _this.dragOverClass);
                            if (_this.drop.observers.length > 0) {
                                _this.zone.run(function () {
                                    _this.drop.next(currentDragEvent);
                                });
                            }
                        }
                    },
