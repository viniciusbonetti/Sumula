...
@Component({
    selector: "tenant-usuario",
    templateUrl: "./tenant-usuario.component.html",
    styleUrls: ["./tenant-usuario.component.css"],
})
export class TenantUsuarioComponent implements OnInit {
